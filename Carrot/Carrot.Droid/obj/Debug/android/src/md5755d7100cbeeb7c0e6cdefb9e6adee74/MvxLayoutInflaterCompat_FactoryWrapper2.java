package md5755d7100cbeeb7c0e6cdefb9e6adee74;


public class MvxLayoutInflaterCompat_FactoryWrapper2
	extends md5755d7100cbeeb7c0e6cdefb9e6adee74.MvxLayoutInflaterCompat_FactoryWrapper
	implements
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MvvmCross.Platforms.Android.Binding.Binders.MvxLayoutInflaterCompat+FactoryWrapper2, MvvmCross, Version=6.0.1.0, Culture=neutral, PublicKeyToken=null", MvxLayoutInflaterCompat_FactoryWrapper2.class, __md_methods);
	}
	...
	public MvxLayoutInflaterCompat_FactoryWrapper2 ()
	{
		...
		if (getClass () == MvxLayoutInflaterCompat_FactoryWrapper2.class)
			mono.android.TypeManager.Activate ("MvvmCross.Platforms.Android.Binding.Binders.MvxLayoutInflaterCompat+FactoryWrapper2, MvvmCross, Version=6.0.1.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
