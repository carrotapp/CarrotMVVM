...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MvvmCross.Platforms.Android.Binding.Binders.MvxLayoutInflaterCompat+FactoryWrapper, MvvmCross, Version=6.0.1.0, Culture=neutral, PublicKeyToken=null", MvxLayoutInflaterCompat_FactoryWrapper.class, __md_methods);
	}
	...
	public MvxLayoutInflaterCompat_FactoryWrapper ()
	{
		...
		if (getClass () == MvxLayoutInflaterCompat_FactoryWrapper.class)
			mono.android.TypeManager.Activate ("MvvmCross.Platforms.Android.Binding.Binders.MvxLayoutInflaterCompat+FactoryWrapper, MvvmCross, Version=6.0.1.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
