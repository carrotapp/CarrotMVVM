...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MvvmCross.Platforms.Android.Binding.Views.MvxFilteringAdapter+MyFilter, MvvmCross, Version=6.0.1.0, Culture=neutral, PublicKeyToken=null", MvxFilteringAdapter_MyFilter.class, __md_methods);
	}
	...
	public MvxFilteringAdapter_MyFilter ()
	{
		...
		if (getClass () == MvxFilteringAdapter_MyFilter.class)
			mono.android.TypeManager.Activate ("MvvmCross.Platforms.Android.Binding.Views.MvxFilteringAdapter+MyFilter, MvvmCross, Version=6.0.1.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}

	public MvxFilteringAdapter_MyFilter (md56a3a7c6d69de5a06d6f9a7aa8b71e7bc.MvxFilteringAdapter p0)
	{
		super ();
		if (getClass () == MvxFilteringAdapter_MyFilter.class)
			mono.android.TypeManager.Activate ("MvvmCross.Platforms.Android.Binding.Views.MvxFilteringAdapter+MyFilter, MvvmCross, Version=6.0.1.0, Culture=neutral, PublicKeyToken=null", "MvvmCross.Platforms.Android.Binding.Views.MvxFilteringAdapter, MvvmCross, Version=6.0.1.0, Culture=neutral, PublicKeyToken=null", this, new java.lang.Object[] { p0 });
	}
