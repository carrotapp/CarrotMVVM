...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MvvmCross.Platforms.Android.Binding.Views.MvxAdapterWithChangedEvent, MvvmCross, Version=6.0.1.0, Culture=neutral, PublicKeyToken=null", MvxAdapterWithChangedEvent.class, __md_methods);
	}
	...
	public MvxAdapterWithChangedEvent ()
	{
		...
		if (getClass () == MvxAdapterWithChangedEvent.class)
			mono.android.TypeManager.Activate ("MvvmCross.Platforms.Android.Binding.Views.MvxAdapterWithChangedEvent, MvvmCross, Version=6.0.1.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
	...
	public MvxAdapterWithChangedEvent (android.content.Context p0)
	{
		super ();
		if (getClass () == MvxAdapterWithChangedEvent.class)
			mono.android.TypeManager.Activate ("MvvmCross.Platforms.Android.Binding.Views.MvxAdapterWithChangedEvent, MvvmCross, Version=6.0.1.0, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0 });
	}
