package md5416066bfd4d44089505bdce5e436f0d4;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MvvmCross.Plugin.Location.Platforms.Android.MvxLocationListener, MvvmCross.Plugin.Location, Version=6.0.1.0, Culture=neutral, PublicKeyToken=null", MvxLocationListener.class, __md_methods);
	}


	public MvxLocationListener ()
	{
		super ();
		if (getClass () == MvxLocationListener.class)
			mono.android.TypeManager.Activate ("MvvmCross.Plugin.Location.Platforms.Android.MvxLocationListener, MvvmCross.Plugin.Location, Version=6.0.1.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
