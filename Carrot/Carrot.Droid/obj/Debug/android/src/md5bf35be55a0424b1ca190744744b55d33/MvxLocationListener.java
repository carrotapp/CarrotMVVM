package md5bf35be55a0424b1ca190744744b55d33;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MvvmCross.Plugin.Location.Platforms.Android.MvxLocationListener, MvvmCross.Plugin.Location", MvxLocationListener.class, __md_methods);
	}
	...
	public MvxLocationListener ()
	{
		...
		if (getClass () == MvxLocationListener.class)
			mono.android.TypeManager.Activate ("MvvmCross.Plugin.Location.Platforms.Android.MvxLocationListener, MvvmCross.Plugin.Location", "", this, new java.lang.Object[] {  });
	}
