...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MvvmCross.Platforms.Android.Binding.Views.MvxListItemView, MvvmCross, Version=6.0.1.0, Culture=neutral, PublicKeyToken=null", MvxListItemView.class, __md_methods);
	}
	...
	public MvxListItemView ()
	{
		...
		if (getClass () == MvxListItemView.class)
			mono.android.TypeManager.Activate ("MvvmCross.Platforms.Android.Binding.Views.MvxListItemView, MvvmCross, Version=6.0.1.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
